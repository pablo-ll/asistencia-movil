...
const SolicitarAusencia = () => {
  ...
  const handleSubmit2 = (
    ...
    Alert.alert("Se envio la solicitud con exito");
  };
        ...
        <ScrollView>
          <Formik
            ...
            onSubmit={(values, actions) => {
              const formattedValues = {
                ...values,
                fechaInicio: values.fechaInicio.slice(0, 10),
                fechaFin: values.fechaFin.slice(0, 10),
                empleadoId: empleado?.id || 0,
              };

              console.log('fechas');

            /*   handleSubmit(formattedValues, actions, setModalVisible); */
            }}
          >
            {({
              handleChange,
                ...
                <View>
                  ...
                  <View style={styles.inputWithIcon}>
                    <Dropdown
                      ...
                      onChange={(item) => setFieldValue("tipo", item.value)}
